...
final class GetFollowersController extends AbstractApiController
{
    use HandleTrait;
    ...
    #[OA\Get(
        ...
        summary: 'Кто подписан на пользователя (cursor-пагинация)',
        security: [['Bearer' => []]],
        tags: ['Follows'],
        parameters: [
    ...
    public function __invoke(
        ...
        $list = $this->handle($this->queryBus, new GetFollowersQuery(
            userId: $request->id,
            cursor: $query->cursor,
            limit: $query->limit,
        ));
